...
async def summarize_text(
    ...
    Args:
        ...
        user_prompt_template: Custom user prompt template with {text} placeholder
        model: Model name
...
async def create_summary_for_transcription(
    ...
    Args:
        db: Database session
        transcription_job: Transcription job to summarize
        prompt_template_id: Optional custom prompt template ID
