...
class User(Base):
    __tablename__ = "users"
    __table_args__ = (
        Index("ix_users_external_auth", "external_auth_provider", "external_auth_id", unique=True),
    )
    ...
    external_auth_provider: Mapped[str | None] = mapped_column(String(50), nullable=True)
